-- GCP FOCUS v1.0 BigQuery View SQL - MODIFIED VERSION
-- Last Updated: October 24, 2024
-- Based on Google's template from March 19, 2024
--
-- MODIFICATION: BilledCost calculation changed to exclude credits
-- This aligns better with FOCUS spec where:
--   - BilledCost = invoiced amount (before credits)
--   - EffectiveCost = actual amount paid (after credits)
--
-- REQUIRED: Replace the following parameters before deploying:
-- 1. Line 134: `project.dataset.gcp_billing_export_resource_v1_account`
--    Replace with your detailed billing export table path
-- 2. Line 137: `project.dataset.cloud_pricing_export`
--    Replace with your price export table path
-- 3. Line 140: 'YYYY-MM-DD'
--    Replace with a date after you enabled pricing export
-- 4. Line 145: "TODO - replace with the billing account ID..."
--    Replace with your billing account ID
--
-- Example:
-- 1. `my-billing-project.billing_data.gcp_billing_export_resource_v1_012345_ABCDEF_6789GH`
-- 2. `my-billing-project.billing_data.cloud_pricing_export`
-- 3. '2024-01-15'
-- 4. "012345-ABCDEF-6789GH"
...
SELECT
  ...
  -- MODIFIED: BilledCost now excludes credits (invoiced amount)
