-- GCP FOCUS v1.0 BigQuery View SQL
-- Last Updated: March 19, 2024
--
-- REQUIRED: Replace the following parameters before deploying:
-- 1. Line 115: `project.dataset.gcp_billing_export_resource_v1_account`
--    Replace with your detailed billing export table path
-- 2. Line 118: `project.dataset.cloud_pricing_export`
--    Replace with your price export table path
-- 3. Line 121: 'YYYY-MM-DD'
--    Replace with a date after you enabled pricing export
-- 4. Line 126: "TODO - replace with the billing account ID..."
